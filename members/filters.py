...
class MemberFilter(filters.FilterSet):
    ...
    grad_year__gte = django_filters.DateTimeFilter(name='education__grad_year', lookup_type='gte')
    grad_year__lte = django_filters.DateTimeFilter(name='education__grad_year', lookup_type='lte')
